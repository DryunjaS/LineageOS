...
const NavBar = () => {
	...
	return (
		<nav className='w-full shadow-xl'>
			<div className='w-10/12 h-20 flex items-center justify-between mx-auto px-3 text-[#555555]'>
				<div>
				...
				<div className='uppercase justify-end gap-7 text-[13px] hidden lg:flex bg-white'>
