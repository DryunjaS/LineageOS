...
const MainPage = () => {
	...
	return (
		<div>
			...
			<section className='mt-20 min-h-[500px] bg-[url("/images/hero_bg.jpg")] bg-cover bg-center lg:min-h-[auto] flex items-end'>
				<div className='w-4/5 flex items-end justify-center lg:justify-between flex-wrap mx-auto mt-10 lg:mt-0'>
					<div className='mx-auto lg:mx-0 lg:w-[400px] mb-10'>
						<h1 className='text-6xl text-center lg:text-start text-white md:w-[690px] font-thin mt-5 mb-3'>
							Дистрибутив LineageOS для Android
						</h1>
						<p className='text-white mb-6 text-center lg:text-start text-xl font-thin flex-wrap'>
						...
						<div className='flex items-center justify-center lg:justify-start'>
							...
							<a
								href='#'
								className='text-white ml-10 font-thin uppercase text-xs'
							>
								Блог
							</a>
						</div>
					...
					<img
						...
						alt='android'
						className='max-h-[500px] max-w-full ml-0 md:ml-16'
					/>
				</div>
			</section>
			<section className='h-64 bg-soft flex items-center'>
				<div className='w-4/5 mx-auto'>
					...
					<h6 className='uppercase text-xs font-bold mb-3'>
						Пока, и спасибо за рыбу
					</h6>
					<p className='flex w-full -ml-1 text-lg font-light'>
						<svg
			...
			<section className='h-auto lg:h-[410px] py-10'>
				<div className='w-4/5 h-auto lg:h-[300px] flex flex-wrap items-center justify-center lg:justify-between mx-auto gap-y-10'>
					<img
						src='/images/individuality.jpg'
						alt='individuality'
						className='w-[290px] h-[282px]'
					/>
			...
			<section className='h-auto py-24 lg:py-0 lg:h-[714px] bg-security flex items-center'>
				<div className='w-4/5 flex flex-row-reverse flex-wrap justify-center lg:justify-between mx-auto text-white text-center lg:text-start gap-y-12'>
					<img
						src='/images/security.png'
						alt='security'
						className='w-[530px] h-[522px] object-contain lg:object-cover'
					/>
					<div className='w-max lg:w-96'>
						...
						<div className='flex items-center justify-between flex-col lg:flex-row gap-y-4'>
							...
							<p className='w-4/5 lg:w-[280px] text-xl font-light'>
			...
			<section className='h-auto lg:h-[482px] overflow-hidden flex items-center py-20 lg:py-0'>
				<div className='w-4/5 flex items-center justify-center lg:justify-end flex-wrap mx-auto gap-y-10'>
					<img
						src='/images/longevity-2.png'
						alt='longevity'
						className='h-[60vw] lg:h-[40vw] w-auto bg-transparent lg:absolute -z-10 left-20'
						style={{ transform: `rotate(${getRotation()}deg)` }}
					/>
					<div className='w-auto lg:w-[475px] text-center lg:text-start'>
			...
			<section className="bg-[url('/images/power_bg.jpg')] bg-cover bg-center h-auto lg:h-[660px] text-white flex items-center py-20 lg:py-0">
				<div className='w-4/5 flex items-center justify-center lg:justify-between flex-wrap-reverse mx-auto gap-y-10'>
					...
					<img
						...
						alt='icons'
						className='w-[55vw] lg:w-[40vw] h-auto'
					/>
				</div>
			</section>
			<section className='px-4 py-24 bg-primary text-white flex items-center justify-center'>
				<div className='h-auto lg:h-[315px] text-center'>
					<svg
						xmlns='http://www.w3.org/2000/svg'
						viewBox='0 0 48 24'
						fill='white'
						className='w-40 h-20 mx-auto mb-10'
					>
					...
					<p className='text-[22px] font-light mb-5'>
			...
			<footer className='p-4 flex items-center justify-center bg-[#eee]'>
				<div className='w-4/5 h-auto lg:h-[232px] flex flex-col lg:flex-row justify-center lg:justify-between font-light text-sm'>
					...
					<div className='flex jus justify-center lg:justify-end py-4 gap-x-3'>
						<a href='#'>
							<svg
								aria-hidden='true'
								xmlns='http://www.w3.org/2000/svg'
